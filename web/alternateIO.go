...
type bargeStackLight struct {
	...
	IsEndGame bool `json:"isEndGameStackLight"`
...
func (web *Web) bargeStackLightGetHandler(w http.ResponseWriter, r *http.Request) {
	...
	bargeLight.Red1, bargeLight.Red2, bargeLight.Blue1, bargeLight.Blue2, bargeLight.IsPlayoffs, bargeLight.IsEndGame, bargeLight.MatchState = web.arena.Plc.GetBargeStackLight()
